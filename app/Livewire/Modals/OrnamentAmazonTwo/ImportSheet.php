...
class ImportSheet extends Component
{
    ...
    {
        if ($component !== 'modals.ornament-amazon-two.import-sheet') {
            return;
        }
    ...
    #[On('ornament-amazon-two-import-sheet-updated')]
    ...
    {
        return view('livewire.modals.ornament-amazon-two.import-sheet');
    }
