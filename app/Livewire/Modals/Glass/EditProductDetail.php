...
class EditProductDetail extends Component
{
    ...
    {
        if ($component !== 'modals.glass.edit-product-detail') {
            return;
        }
    ...
    public function open(int $assetId): void
    {
        ...
        $asset = app(GlassService::class)->assetForUser(auth()->user(), $assetId);
    ...
    public function save(): void
    {
        ...
        $this->dispatch('toast', type: 'success', title: 'Successfully saved!', message: 'Da cap nhat item Glass.');
        $this->close();
    }

    public function render(): View
    {
        return view('livewire.modals.glass.edit-product-detail');
    }
}
