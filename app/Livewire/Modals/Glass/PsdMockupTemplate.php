...
class PsdMockupTemplate extends Component
{
    ...
    {
        if ($component !== 'modals.glass.psd-mockup-template') {
            return;
        }
    ...
    public function save(): void
    {
        ...
        try {
            app(PsdMockupTemplateService::class)->uploadGlassTemplate(
                auth()->user(),
                $validated['psdFile'],
                $validated['name'] ?: null,
            );
    ...
    {
        app(PsdMockupTemplateService::class)->activateGlassTemplate(auth()->user(), $templateId);
    ...
    {
        return view('livewire.modals.glass.psd-mockup-template', [
            'templates' => app(PsdMockupTemplateService::class)->glassTemplatesForUser(auth()->user()),
        ]);
    }
}
