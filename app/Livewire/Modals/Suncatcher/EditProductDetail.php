...
class EditProductDetail extends Component
{
    ...
    {
        if ($component !== 'modals.suncatcher.edit-product-detail') {
            return;
        }
    ...
    public function open(int $assetId): void
    {
        ...
        $asset = app(SuncatcherService::class)->assetForUser(auth()->user(), $assetId);
    ...
    public function save(): void
    {
        ...
        app(SuncatcherService::class)->updateProductDetail(
            auth()->user(),
            $this->assetId,
            $validated['keyword'],
            $validated['imageLink'],
        ...
        $this->dispatch('suncatcher-product-design-updated', assetId: $this->assetId);
        $this->dispatch('toast', type: 'success', title: 'Successfully saved!', message: 'Da cap nhat item Suncatcher.');
        $this->close();
    }

    public function render(): View
    {
        return view('livewire.modals.suncatcher.edit-product-detail');
    }
}
