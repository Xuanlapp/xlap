    ...
    <div class="mx-auto max-w-[1520px] px-4 py-5 sm:px-6 lg:px-8">
        <div class="mb-4 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
            <div class="flex flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex min-w-0 items-center gap-3">
                    ...
                    <div class="min-w-0">
                        <h1 class="text-base font-bold text-slate-950">Wali Workspace</h1>
                        <p class="mt-0.5 text-xs text-slate-500">Quan ly bang luong nhan vien theo thang</p>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    >
                        ...
                        <span wire:loading.remove wire:target="openMonthSummary">Tong ket thang</span>
                        <span wire:loading wire:target="openMonthSummary">Dang mo...</span>
                    </button>

                    <button
                        type="button"
                        wire:click="openAddEmployee"
                        class="inline-flex h-9 items-center justify-center gap-2 rounded-md bg-blue-500 px-3 text-xs font-bold text-white shadow-sm transition hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-200"
                    >
        ...
        <div class="mb-4 grid gap-4 md:grid-cols-3">
            <div class="overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wide text-slate-400">Nhan vien</p>
                <p class="mt-2 text-2xl font-bold text-slate-950">{{ $summary['employees'] }}</p>
                <p class="mt-1 text-xs text-slate-500">Tong so nhan vien trong ky</p>
            </div>
            <div class="overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wide text-slate-400">Tong luong</p>
                <p class="mt-2 text-2xl font-bold text-violet-600">{{ number_format($summary['total_salary'], 0, ',', '.') }}</p>
                <p class="mt-1 text-xs text-slate-500">Tong luong phai tra</p>
            </div>
            <div class="overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wide text-slate-400">Thuc nhan</p>
                <p class="mt-2 text-2xl font-bold text-emerald-600">{{ number_format($summary['net_received'], 0, ',', '.') }}</p>
                <p class="mt-1 text-xs text-slate-500">Tong thuc nhan sau khau tru</p>
            </div>
        </div>

        <div class="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-4 py-3">
                <h2 class="text-sm font-bold text-slate-950">Danh sach luong {{ $monthLabel }}</h2>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200 text-[10px] leading-tight">
                    <thead class="bg-slate-50 text-[9px] font-semibold uppercase tracking-wide text-slate-500">
                        <tr>
                            <th class="px-2 py-2 text-left align-middle">Nhan vien</th>
                            <th class="px-2 py-2 text-right align-middle">Luong co ban</th>
                            <th class="px-2 py-2 text-right align-middle">Luong cung bien dong</th>
                            <th class="px-2 py-2 text-right align-middle">Diem hieu suat</th>
                            <th class="px-2 py-2 text-right align-middle">Di tre (phut)</th>
                            <th class="px-2 py-2 text-right align-middle">Diem tru</th>
                            <th class="px-2 py-2 text-right align-middle">Xin nghi</th>
                            <th class="px-2 py-2 text-right align-middle">So ngay duoc nghi</th>
                            <th class="px-2 py-2 text-right align-middle">Nghi vuot</th>
                            <th class="px-2 py-2 text-right align-middle">Cong chuan</th>
                            <th class="px-2 py-2 text-right align-middle">Cong thuc te</th>
                            <th class="px-2 py-2 text-right align-middle">Diem tinh luong</th>
                            <th class="px-2 py-2 text-right align-middle">Thuong ngay</th>
                            <th class="px-2 py-2 text-right align-middle">Bo sung</th>
                            <th class="px-2 py-2 text-right align-middle">Tien khac</th>
                            <th class="px-2 py-2 text-left align-middle">Note</th>
                            <th class="px-2 py-2 text-right align-middle">Tong luong</th>
                            <th class="px-2 py-2 text-right align-middle">Tien diem le</th>
                            <th class="px-2 py-2 text-right align-middle">Hoa hong</th>
                            <th class="px-2 py-2 text-right align-middle">Thuc nhan</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @empty
                            <tr>
                                <td colspan="19" class="px-2 py-8 text-center text-[10px] text-slate-400">Chua co du lieu cho ky nay.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
