    ...
    <div class="fixed inset-0 z-[90] flex items-center justify-center p-4">
        ...
        <div class="relative z-[91] flex max-h-[90vh] w-full max-w-[98vw] flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-2xl">
            <div class="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                <div>
                    <h3 class="text-base font-bold text-slate-950">Tong ket thang {{ $monthLabel }}</h3>
                    <p class="mt-1 text-xs text-slate-500">Chi nhap cac truong can thiet, he thong se tu tinh luong.</p>
                </div>
                <button type="button" wire:click="close" class="rounded-md p-2 text-slate-400 hover:bg-slate-100 hover:text-slate-700">ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢</button>
            </div>
            ...
            <div class="overflow-auto px-5 py-4">
                <table class="min-w-full divide-y divide-slate-200 text-[11px]">
                    <thead class="sticky top-0 bg-slate-50 text-[10px] font-semibold uppercase tracking-wide text-slate-500">
                        <tr>
                            <th class="min-w-[180px] px-2 py-2 text-left">Nhan vien</th>
                            <th class="min-w-[120px] px-2 py-2 text-right">Diem so</th>
                            <th class="min-w-[110px] px-2 py-2 text-right">Di tre</th>
                            <th class="min-w-[110px] px-2 py-2 text-right">Xin nghi</th>
                            <th class="min-w-[130px] px-2 py-2 text-right">So ngay duoc nghi</th>
                            <th class="min-w-[130px] px-2 py-2 text-right">Thuong ngay</th>
                            <th class="min-w-[130px] px-2 py-2 text-right">Tien bo sung</th>
                            <th class="min-w-[130px] px-2 py-2 text-right">Tien khac</th>
                            <th class="min-w-[260px] px-2 py-2 text-left">Note</th>
                            <th class="min-w-[140px] px-2 py-2 text-right">Tong luong</th>
                            <th class="min-w-[140px] px-2 py-2 text-right">Thuc nhan</th>
                        </tr>
                    </thead>
