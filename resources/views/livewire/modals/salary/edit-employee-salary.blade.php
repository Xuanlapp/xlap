                ...
                <table class="min-w-full divide-y divide-slate-200 text-[11px]">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <tr wire:key="edit-employee-salary-{{ $salaryMonth }}-{{ $employeeId }}">
                            ...
                            <td class="px-2 py-2"><input type="text" inputmode="numeric" wire:model.blur="row.base_salary" oninput="this.value = this.value.replace(/\D/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, '.')" class="w-32 rounded-md border border-slate-200 px-2 py-1 text-right"></td>
                            <td class="px-2 py-2"><input type="text" inputmode="decimal" wire:model.blur="row.performance_score" class="w-28 rounded-md border border-slate-200 px-2 py-1 text-right"></td>
                            <td class="px-2 py-2"><input type="text" inputmode="numeric" wire:model.blur="row.late_minutes" class="w-20 rounded-md border border-slate-200 px-2 py-1 text-right"></td>
                            <td class="px-2 py-2"><input type="text" inputmode="numeric" wire:model.blur="row.leave_days" class="w-20 rounded-md border border-slate-200 px-2 py-1 text-right"></td>
                            <td class="px-2 py-2"><input type="text" inputmode="numeric" wire:model.blur="row.allowed_leave_days" class="w-20 rounded-md border border-slate-200 px-2 py-1 text-right"></td>
                            ...
                            <td class="px-2 py-2"><textarea wire:model.blur="row.note" class="min-w-[300px] rounded-md border border-slate-200 px-2 py-1 text-[11px]"></textarea></td>
