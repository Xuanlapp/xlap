        ...
        <div class="relative overflow-y-auto z-[91] w-full max-w-lg overflow-hidden rounded-xl border border-slate-200 bg-white shadow-2xl">
            <div class="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-500">Bắt buộc nhập tên và lương cơ bản. Thêm ảnh nhân viên được nha.</p>
                </div>
            ...
            <div class="space-y-4 px-5 py-4">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-700">Ảnh nhân viên</label>
                    ...
                    <div wire:loading wire:target="avatar" class="mt-2 text-xs text-blue-600">Đang tải ảnh lên...</div>
                    @if ($avatar)
            ...
            <div class="flex items-center justify-end gap-3 border-t border-slate-200 px-5 py-4">
                ...
                <button type="button" wire:click="save" wire:loading.attr="disabled" wire:target="save,avatar" class="inline-flex h-10 items-center justify-center gap-2 rounded-md bg-blue-500 px-4 text-sm font-bold text-white hover:bg-blue-600 disabled:cursor-not-allowed disabled:opacity-60">
                    ...
                    <span wire:loading wire:target="save,avatar">Đang xử lý...</span>
                </button>
            </div>
        </div>
    </div>
