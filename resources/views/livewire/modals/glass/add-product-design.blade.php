<div>
    @if ($isOpen)
        ...
        >
            <button type="button" class="fixed inset-0 cursor-default" wire:click="close" aria-label="Close add glass modal"></button>
...
<div>
                            ...
                            <x-input
                                ...
                                type="text"
                                class="block w-full"
                                placeholder="Vui lòng có chữ sản phẩm ví vụ:Lap glass"
                            />
