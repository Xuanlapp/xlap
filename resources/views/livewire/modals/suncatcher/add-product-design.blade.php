<div>
    @if ($isOpen)
        <div
            ...
            x-on:suncatcher-competitor-scrape-finished.window="stopTimer()"
        ...
        >
            <button type="button" class="fixed inset-0 cursor-default" wire:click="close" aria-label="Close add suncatcher modal"></button>
            ...
            <div class="relative overflow-y-auto z-10 max-h-full w-full max-w-5xl">
                <form wire:submit.prevent="save" class="relative overflow-hidden rounded-2xl bg-white shadow-2xl">
                    <div class="flex items-center justify-between border-b border-gray-200 p-4 md:p-5">
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900">Add Suncatcher</h3>
                    ...
                    <div class="max-h-[75vh] space-y-5 overflow-y-auto p-4 md:p-5">
                        <div>
                            <label for="suncatcher-competitor-url" class="mb-2 block text-sm font-medium text-gray-900">URL doi thu</label>
                            <x-input
                                id="suncatcher-competitor-url"
