            ...
            <div class="mx-auto mt-6 w-full max-w-8xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_24px_70px_rgba(15,23,42,0.12)]">
                <div class="flex items-start justify-between gap-4 border-b border-slate-200 px-5 py-5 md:px-6">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500">Upload product rows with Link Product, Link Ipnut Main Image, optional Link Main Image and optional Keyword Phrase.</p>
                        <p class="mt-2 text-sm text-slate-600">
                            Template:
                            <a href="{{ asset('storage/import-templates/suncatcher-import-template.xlsx') }}" download="suncatcher-import-template.xlsx" class="font-semibold text-emerald-600 underline decoration-emerald-200 underline-offset-4 transition hover:text-emerald-700">
                                suncatcher-import-template.xlsx
                            </a>
                        </p>
                    </div>
                ...
                <div class="space-y-4 px-5 py-5 md:px-6" x-data="{ hiddenRows: [] }">
                    @if ($rows === [] && $rowErrors === [])
                        <label for="suncatcher-import-excel" class="relative block cursor-pointer overflow-hidden rounded-2xl border border-dashed border-slate-300 bg-white px-5 py-8 text-center shadow-sm transition hover:border-slate-400 hover:bg-slate-50">
                            ...
                            <input id="suncatcher-import-excel" type="file" wire:model.live="excelFile" accept=".xlsx,.xls,.csv,.txt" class="sr-only">
                                ...
                                <table class="min-w-full divide-y divide-slate-200 text-left text-sm">
                                    <thead class="bg-slate-50 text-xs uppercase tracking-wide text-slate-500">
                                        <tr>
                                            ...
                                            <th class="min-w-[320px] px-4 py-3">Link Ipnut Main Image</th>
