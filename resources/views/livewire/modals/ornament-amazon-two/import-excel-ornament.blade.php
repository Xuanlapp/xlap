        ...
        <div class="fixed inset-0 z-50 overflow-y-auto bg-gray-900/50 p-4 md:p-5">
            <div class="mx-auto mt-16 w-full max-w-12xl rounded-2xl bg-white shadow-2xl">
                ...
                <div class="space-y-5 px-6 py-6">
                    <label for="ornament-amazon-two-import-excel" class="block cursor-pointer rounded-2xl border border-dashed border-gray-300 bg-gray-50 px-5 py-6 text-center transition hover:border-gray-400 hover:bg-gray-100">
                        ...
                        <input id="ornament-amazon-two-import-excel" type="file" wire:model.live="excelFile" accept=".xlsx,.csv" class="sr-only">
                    </label>
                        ...
                        <div class="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3">
                            <div class="flex items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Import will use Link Product and Link Main Image from your file.</p>
                                </div>
